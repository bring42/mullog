<script lang="ts">
  ...
  const dispatch = createEventDispatcher<{ change: FilterState; close: void }>();
...
<aside class="filter-rail" class:open aria-label="Filter rail">
  ...
  <section class="panel search-panel">
    <header class="panel-header"><span>LIVE FILTERS</span></header>
  ...
  <section class="panel">
    <header class="panel-header"><span>SEVERITY</span></header>
  ...
  <section class="panel">
    <header class="panel-header"><span>CATEGORY / SOURCE</span></header>
  ...
  {#if facets.columns.length > 0}
    <section class="panel">
      <header class="panel-header"><span>CSV COLUMN FACETS</span></header>
      <div class="column-facets">
  ...
  <section class="panel warnings-panel">
    <header class="panel-header"><span>PARSE WARNINGS</span><span>{detection?.warnings.length ?? 0}</span></header>
